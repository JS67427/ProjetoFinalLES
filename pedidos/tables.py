...
class PedidosTable(django_tables.Table):
    ...
    def render_acoes(self, record):
        ...
        quinto_botao = """<span class="icon"></span>"""
        ...
        if record.tipo.id == 1:
            ...
            primeiro_botao = f"""
                    ...
                    """
        elif record.tipo.id == 5:
            primeiro_botao = f"""
                    <a data-tooltip="Consultar" href="consultar_pedido_de_aluno/{record.id}">
                        <span class="icon">
                            <i class="mdi mdi-eye mdi-24px" style="color: #32CD32" ></i>
                        </span>
                    </a>
                    """
        elif record.tipo.id == 6:
            primeiro_botao = f"""
                    <a data-tooltip="Consultar" href="consultar_pedido_de_parecer/{record.id}">
                        <span class="icon">
                            <i class="mdi mdi-eye mdi-24px" style="color: #32CD32" ></i>
                        </span>
                    </a>
        ...
        if user.groups.filter(name = "Docente").exists():
            if record.estado_0.id == 1:
                if record.tipo.id == 1:
                    ...
                    segundo_botao = f""" <a data-tooltip="Editar" href="eliminar_pedido_de_aluno/{record.id}"  class="icon">
                        <i class="mdi mdi-circle-edit-outline mdi-24px"></i>
                    </a>
                    """
                    terceiro_botao = f"""<a  data-tooltip="Eliminar" href="eliminar_pedido_de_aluno/{record.id}" class="icon has-text-danger" >
                        <i class="mdi mdi-trash-can mdi-24px"></i>
                    </a>
                    """
                elif record.tipo.id == 6:
                    segundo_botao = f""" <a data-tooltip="Editar" href="editar_pedido_de_parecer/{record.id}"  class="icon">
                        <i class="mdi mdi-circle-edit-outline mdi-24px"></i>
                    </a>
                    """
                    terceiro_botao = f"""<a  data-tooltip="Eliminar" href="eliminar_pedido_de_parecer/{record.id}" class="icon has-text-danger" >
                        <i class="mdi mdi-trash-can mdi-24px"></i>
                    </a>
                    """   
                ...
                quarto_botao = f"""
                            ...
                            """
                quinto_botao = ""
                if record.estado_0.id == 6:  # Verifica se o pedido está arquivado
                    quinto_botao = f"""
                        <a data-tooltip="Desarquivar" href="desarquivar/{record.id}">
                            <span class="icon">
                            <i class="mdi mdi-restore mdi-24px" style="color: rgb(0,0,0) "></i>
                        </span>
                    </a>
                """
                else:
                    quinto_botao = f"""
                        <a data-tooltip="Arquivar" href="arquivar/{record.id}">
                            <span class="icon">
                                <i class="mdi mdi-archive mdi-24px" style="color: rgb(0,0,0) "></i>
                        </span>
                    </a>
                """
